...
- [x] **Step 3: Implement minimal store/frontend fixes**
...
- [x] **Step 4: Run tests and evaluator**
...
- [x] **Step 3: Implement contracts and deterministic computation**
...
- [x] **Step 3: Implement audit phases and gate wiring**
...
- [x] **Step 4: Add minimal fake auditor driver**
...
- [x] **Step 1: Write evaluator scenario and dashboard assertions**
...
- [x] **Step 3: Restart remote dashboard**
