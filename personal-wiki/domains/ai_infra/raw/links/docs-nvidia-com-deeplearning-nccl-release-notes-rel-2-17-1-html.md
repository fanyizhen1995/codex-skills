---
type: RawSource
title: https://docs.nvidia.com/deeplearning/nccl/release-notes/rel_2-17-1.html
source_kind: web
url: https://docs.nvidia.com/deeplearning/nccl/release-notes/rel_2-17-1.html
captured: 2026-06-24
status: ingested
---
# Snapshot
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en-us" xml:lang="en-us">
   <head>
      ...
      <meta name="DC.Title" content="NCCL Release 2.17.1"></meta>
      <meta name="abstract" content=""></meta>
      <meta name="description" content=""></meta>
      <meta name="DC.Format" content="XHTML"></meta>
      <meta name="DC.Identifier" content="rel_2-17-1"></meta>
   ...
   <body>
      ...
      <div id="site-content">
         ...
         <div id="contents-container">
            ...
            <article id="contents">
               <div class="topic nested0" id="rel_2-17-1"><a name="rel_2-17-1" shape="rect">
                     <!-- --></a><h2 class="title topictitle1"><a href="#rel_2-17-1" name="rel_2-17-1" shape="rect"><span class="ph">NCCL</span> Release 2.17.1</a></h2>
                  <div class="body refbody">
                     <p class="shortdesc"></p>
                     <div class="section" id="rel_2-17-1__section_n2q_kp4_phb"><a name="rel_2-17-1__section_n2q_kp4_phb" shape="rect">
                           <!-- --></a><p class="p">This is the <span class="ph">NCCL</span> 2.17.1 release notes. For previous NCCL release notes, refer to the
                     ...
                     <div class="section">
                        ...
                        <div class="p"><span class="ph">NCCL</span> 2.17.1 has been tested with the following:<a name="rel_2-17-1__ul_g3n_yw2_mhb" shape="rect">
                              <!-- --></a><ul class="ul" id="rel_2-17-1__ul_g3n_yw2_mhb">
                              <li class="li">
                     ...
                     <div class="section">
                        ...
                        <ul class="ul">
                           <li class="li">
                              <p class="p">Add support for NVLink SHARP Reduction / Broadcast to accelerate intra-node allreduce operations.
                                 
                              </p>
                           </li>
                           <li class="li">
                              <p class="p">Add new fields in the communicator configuration structure: Cooperative Group Array cluster size, minimum and maximum number
                                 of CTAs, network plugin name to use.
                                 
                              </p>
                           </li>
                           <li class="li">
                              <p class="p">Update NVTX3 includes.</p>
                           </li>
                        </ul>
                     </div>
                     <div class="section">
                        ...
                        <ul class="ul">
                           ...
                           <li class="li">
                              <p class="p">Performance is sub-optimal for NCCL communicators using 1 NIC per node on DGX H100/HGX H100 + NDR. It can be worked around
                                 by setting the following parameter:
                              </p><pre xml:space="preserve">NCCL_MIN_NCHANNELS=4</pre></li>
                        </ul>
                     </div>
                     <div class="section">
                        <h2 class="title sectiontitle">Fixed Issues</h2>
                        <p class="p">The following issues have been resolved in <span class="ph">NCCL</span> 2.17.1:
                        </p>
                        <ul class="ul">
                           <li class="li">
                              <p class="p">Fix crash when one CollNet (SHARP) rail fails to initialize.</p>
                           </li>
                           <li class="li">
                              <p class="p">Re-enable the LL128 protocol on H100 when we use PXN to close rings.</p>
                           </li>
                        </ul>
                     </div>
                     <div class="section">
