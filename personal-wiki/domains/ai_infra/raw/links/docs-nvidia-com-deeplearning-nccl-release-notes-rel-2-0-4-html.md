---
type: RawSource
title: https://docs.nvidia.com/deeplearning/nccl/release-notes/rel_2.0.4.html
source_kind: web
url: https://docs.nvidia.com/deeplearning/nccl/release-notes/rel_2.0.4.html
captured: 2026-06-24
status: pending
---
# Snapshot
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en-us" xml:lang="en-us">
   <head>
      ...
      <meta name="DC.Title" content="NCCL Release 2.0.4"></meta>
      <meta name="abstract" content=""></meta>
      <meta name="description" content=""></meta>
      <meta name="DC.Format" content="XHTML"></meta>
      <meta name="DC.Identifier" content="rel_2.0.4"></meta>
   ...
   <body>
      ...
      <div id="site-content">
         ...
         <div id="contents-container">
            ...
            <article id="contents">
               <div class="topic nested0" id="rel_2.0.4"><a name="rel_2.0.4" shape="rect">
                     <!-- --></a><h2 class="title topictitle1"><a href="#rel_2.0.4" name="rel_2.0.4" shape="rect"><span class="ph">NCCL</span> Release 2.0.4</a></h2>
                  <div class="body refbody">
                     ...
                     <div class="section">
                        ...
                        <div class="p">This <span class="ph">NCCL</span> release includes the following key features and
                           enhancements.<a name="rel_2.0.4__ul_cyw_njy_h1b" shape="rect">
                              <!-- --></a><ul class="ul" id="rel_2.0.4__ul_cyw_njy_h1b">
                              <li class="li"><span class="ph">NCCL</span> 2.0.4 provides support for intra-node and inter-node
                                 communication. 
                              </li>
                     ...
                     <div class="section">
                        <h2 class="title sectiontitle">Using <span class="ph">NCCL</span> 2.0.4
                        </h2>
                        <div class="p">Ensure you are familiar with the following notes when using this release.<a name="rel_2.0.4__ul_n5h_htf_21b" shape="rect">
                              <!-- --></a><ul class="ul" id="rel_2.0.4__ul_n5h_htf_21b">
                              ...
                              <li class="li"><span class="ph">NCCL</span> 2.0.4 has the new configuration file support. The <span class="ph">NCCL</span> environment variables can now be set in
                     ...
                     <div class="section">
                        ...
                        <div class="p"><a name="rel_2.0.4__ul_x3h_wjy_h1b" shape="rect">
                              <!-- --></a><ul class="ul" id="rel_2.0.4__ul_x3h_wjy_h1b">
                              ...
                              <li class="li">RoCE is not supported.  </li>
