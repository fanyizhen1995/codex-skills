---
type: RawSource
title: https://docs.nvidia.com/deeplearning/nccl/release-notes/rel_2-30-4.html
source_kind: web
url: https://docs.nvidia.com/deeplearning/nccl/release-notes/rel_2-30-4.html
captured: 2026-06-24
status: pending
---
# Snapshot
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en-us" xml:lang="en-us">
   <head>
      ...
      <meta name="DC.Title" content="NCCL Release 2.30.4"></meta>
      <meta name="abstract" content=""></meta>
      <meta name="description" content=""></meta>
      <meta name="DC.Format" content="XHTML"></meta>
      <meta name="DC.Identifier" content="rel_2-30-4"></meta>
   ...
   <body>
      ...
      <div id="site-content">
         ...
         <div id="contents-container">
            ...
            <article id="contents">
               <div class="topic nested0" id="rel_2-30-4"><a name="rel_2-30-4" shape="rect">
                     <!-- --></a><h2 class="title topictitle1"><a href="#rel_2-30-4" name="rel_2-30-4" shape="rect"><span class="ph">NCCL</span> Release 2.30.4</a></h2>
                  <div class="body refbody">
                     <p class="shortdesc"></p>
                     <div class="section" id="rel_2-30-4__section_n2q_kp4_phb"><a name="rel_2-30-4__section_n2q_kp4_phb" shape="rect">
                           <!-- --></a><p class="p">This is the <span class="ph">NCCL</span> 2.30.4 release notes. For previous NCCL release
                     ...
                     <div class="section">
                        ...
                        <div class="p"><span class="ph">NCCL</span> 2.30.4 has been tested with the following:<a name="rel_2-30-4__ul_g3n_yw2_mhb" shape="rect">
                              <!-- --></a><ul class="ul" id="rel_2-30-4__ul_g3n_yw2_mhb">
                              <li class="li">
                     ...
                     <div class="section">
                        ...
                        <ul class="ul">
                           <li class="li">
                              <p class="p">Added support for elastic buffers with GIN.</p>
                           </li>
                        </ul>
                     </div>
                     <div class="section">
                        <h2 class="title sectiontitle">Fixed Issues</h2>
                        <p class="p">The following issues have been resolved in <span class="ph">NCCL</span> 2.30.4:
                        </p>
                        <ul class="ul">
                           <li class="li">
                              <p class="p">Fixed issue with extra headers for nccl_param feature (Github issue <a class="xref" href="https://github.com/NVIDIA/nccl/issues/2105" shape="rect">#2105</a>).
                              </p>
                           </li>
                        </ul>
                     </div>
                     <div class="section">
                        ...
                        <ul class="ul">
                           <li class="li">
                              <p class="p">Applications that use GIN APIs need to be recompiled with 2.30.4 to work with 2.30.4 runtime.</p>
                           </li>
                           <li class="li">
                           ...
                           <li class="li">
                              <p class="p">The elastic buffer feature with GIN is not supported on directNIC platforms.</p>
                           </li>
                        </ul>
                     </div>
                     <div class="section">
