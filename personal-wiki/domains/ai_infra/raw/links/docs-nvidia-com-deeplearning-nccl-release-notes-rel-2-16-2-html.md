---
type: RawSource
title: https://docs.nvidia.com/deeplearning/nccl/release-notes/rel_2-16-2.html
source_kind: web
url: https://docs.nvidia.com/deeplearning/nccl/release-notes/rel_2-16-2.html
captured: 2026-06-24
status: ingested
---
# Snapshot
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en-us" xml:lang="en-us">
   <head>
      ...
      <meta name="DC.Title" content="NCCL Release 2.16.2"></meta>
      <meta name="abstract" content=""></meta>
      <meta name="description" content=""></meta>
      <meta name="DC.Format" content="XHTML"></meta>
      <meta name="DC.Identifier" content="rel_2-16-2"></meta>
   ...
   <body>
      ...
      <div id="site-content">
         ...
         <div id="contents-container">
            ...
            <article id="contents">
               <div class="topic nested0" id="rel_2-16-2"><a name="rel_2-16-2" shape="rect">
                     <!-- --></a><h2 class="title topictitle1"><a href="#rel_2-16-2" name="rel_2-16-2" shape="rect"><span class="ph">NCCL</span> Release 2.16.2</a></h2>
                  <div class="body refbody">
                     <p class="shortdesc"></p>
                     <div class="section" id="rel_2-16-2__section_n2q_kp4_phb"><a name="rel_2-16-2__section_n2q_kp4_phb" shape="rect">
                           <!-- --></a><p class="p">This is the <span class="ph">NCCL</span> 2.16.2 release notes. For previous NCCL release notes, refer to the
                     ...
                     <div class="section">
                        ...
                        <div class="p"><span class="ph">NCCL</span> 2.16.2 has been tested with the following:<a name="rel_2-16-2__ul_g3n_yw2_mhb" shape="rect">
                              <!-- --></a><ul class="ul" id="rel_2-16-2__ul_g3n_yw2_mhb">
                              <li class="li">
                     ...
                     <div class="section">
                        ...
                        <ul class="ul">
                           <li class="li">
                              <p class="p">Add support for CUDA 12.0</p>
                           </li>
                           <li class="li">
                              <p class="p">Make socket support more resistant to network scanners</p>
                           </li>
                           <li class="li">
                              <p class="p">Improve performance on large CUDA graphs, reducing dependencies</p>
                           </li>
                           <li class="li">
                              <p class="p">Compile with profiling API by default</p>
                           </li>
                           <li class="li">
                              <p class="p">Extend NVTX instrumentation with call arguments</p>
                           </li>
                        </ul>
                     </div>
                     <div class="section">
                        <h2 class="title sectiontitle">Fixed Issues</h2>
                        <p class="p">The following issues have been resolved in <span class="ph">NCCL</span> 2.16.2:
                        </p>
                        <ul class="ul">
                           <li class="li">
                              <p class="p">Various fixes to <samp class="ph codeph">ncclCommAbort</samp></p>
                           </li>
                           <li class="li">
                              <p class="p">Make service thread polling resistant to EINTR</p>
                           </li>
                           <li class="li">
                              <p class="p">Adjust inter-socket AMD bandwidth model to favor faster paths</p>
                           </li>
                        </ul>
                     </div>
                     <div class="section">
