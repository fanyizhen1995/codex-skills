---
type: RawSource
title: https://docs.nvidia.com/deeplearning/nccl/release-notes/rel_2-12-7.html
source_kind: web
url: https://docs.nvidia.com/deeplearning/nccl/release-notes/rel_2-12-7.html
captured: 2026-06-24
status: pending
---
# Snapshot
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en-us" xml:lang="en-us">
   <head>
      ...
      <meta name="DC.Title" content="NCCL Release 2.12.7"></meta>
      <meta name="abstract" content=""></meta>
      <meta name="description" content=""></meta>
      <meta name="DC.Format" content="XHTML"></meta>
      <meta name="DC.Identifier" content="rel_2-12-7"></meta>
   ...
   <body>
      ...
      <div id="site-content">
         ...
         <div id="contents-container">
            ...
            <article id="contents">
               <div class="topic nested0" id="rel_2-12-7"><a name="rel_2-12-7" shape="rect">
                     <!-- --></a><h2 class="title topictitle1"><a href="#rel_2-12-7" name="rel_2-12-7" shape="rect"><span class="ph">NCCL</span> Release 2.12.7</a></h2>
                  <div class="body refbody">
                     <p class="shortdesc"></p>
                     <div class="section" id="rel_2-12-7__section_n2q_kp4_phb"><a name="rel_2-12-7__section_n2q_kp4_phb" shape="rect">
                           <!-- --></a><p class="p">This is the <span class="ph">NCCL</span> 2.12.7 release notes. For previous NCCL release notes, refer to the
                     ...
                     <div class="section">
                        ...
                        <div class="p"><span class="ph">NCCL</span> 2.12.7 has been tested with the following:<a name="rel_2-12-7__ul_g3n_yw2_mhb" shape="rect">
                              <!-- --></a><ul class="ul" id="rel_2-12-7__ul_g3n_yw2_mhb">
                              <li class="li">
                     ...
                     <div class="section">
                        ...
                        <ul class="ul">
                           <li class="li">
                              <p class="p">Added NVLink-optimized network communication to keep traffic rail-local (PXN).</p>
                           </li>
                           <li class="li">
                              <p class="p">Improved alltoall latency by aggregating messages within a node to a given destination.</p>
                           </li>
                           <li class="li">
                              <p class="p">Added new v5 plugin API with grouped receives and tags, keeping compatibility for v4 plugins.</p>
                           </li>
                           <li class="li">
                              <p class="p">Added naming of NCCL threads to help debugging.</p>
                           </li>
                           <li class="li">
                              <p class="p">Added support for Relaxed Ordering for IB.</p>
                           </li>
                           <li class="li">
                              <p class="p">Added profiling and timing infrastructure.</p>
                           </li>
                        </ul>
                     </div>
                     <div class="section">
                        <h2 class="title sectiontitle">Fixed Issues</h2>
                        <div class="p">The following issues have been resolved in <span class="ph">NCCL</span> 2.12.7:
                           <ul class="ul">
                              <li class="li">
                                 <p class="p">Fixed NVLink detection and avoid data corruption when some NVLinks are down.</p>
                              </li>
                           </ul>
                        </div>
                     </div>
