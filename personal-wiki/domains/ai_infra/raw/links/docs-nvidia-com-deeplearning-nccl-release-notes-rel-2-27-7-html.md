---
type: RawSource
title: https://docs.nvidia.com/deeplearning/nccl/release-notes/rel_2-27-7.html
source_kind: web
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en-us" xml:lang="en-us">
   <head>
      ...
      <meta name="DC.Title" content="NCCL Release 2.27.7"></meta>
      <meta name="abstract" content=""></meta>
      <meta name="description" content=""></meta>
      <meta name="DC.Format" content="XHTML"></meta>
      <meta name="DC.Identifier" content="rel_2-27-7"></meta>
   ...
   <body>
      ...
      <div id="site-content">
         ...
         <div id="contents-container">
            ...
            <article id="contents">
               <div class="topic nested0" id="rel_2-27-7"><a name="rel_2-27-7" shape="rect">
                     <!-- --></a><h2 class="title topictitle1"><a href="#rel_2-27-7" name="rel_2-27-7" shape="rect"><span class="ph">NCCL</span> Release 2.27.7</a></h2>
                  <div class="body refbody">
                     <p class="shortdesc"></p>
                     <div class="section" id="rel_2-27-7__section_n2q_kp4_phb"><a name="rel_2-27-7__section_n2q_kp4_phb" shape="rect">
                           <!-- --></a><p class="p">This is the <span class="ph">NCCL</span> 2.27.7 release notes. For previous NCCL release
                     ...
                     <div class="section">
                        ...
                        <div class="p"><span class="ph">NCCL</span> 2.27.7 has been tested with the following:<a name="rel_2-27-7__ul_g3n_yw2_mhb" shape="rect">
                              <!-- --></a><ul class="ul" id="rel_2-27-7__ul_g3n_yw2_mhb">
                              <li class="li">
                              ...
                              <li class="li">
                                 <p class="p">This <span class="ph">NCCL</span> release supports <a class="xref" href="https://docs.nvidia.com/cuda/archive/12.2.0/" target="_blank" shape="rect"><u class="ph u">CUDA 12.2</u></a>, <a class="xref" href="https://docs.nvidia.com/cuda/archive/12.4.0/" target="_blank" shape="rect"><u class="ph u">CUDA 12.4</u></a>, and <a class="xref" href="https://docs.nvidia.com/cuda/archive/12.9.0/" target="_blank" shape="rect"><u class="ph u">CUDA 12.9</u></a>. The provided prebuilt
                                    binaries should work with other CUDA 12.x versions as well. <a class="xref" href="https://developer.nvidia.com/cuda-toolkit-archive" target="_blank" shape="rect"><u class="ph u">CUDA 13.0</u></a> is supported as well.
                                 </p>
                              </li>
                           </ul>
                        </div>
                     ...
                     <div class="section">
                        ...
                        <ul class="ul">
                           <li class="li">
                              <p class="p">Added support for CUDA 13.0.</p>
                           </li>
                        </ul>
                     </div>
                     <div class="section">
                        <h2 class="title sectiontitle">Fixed Issues</h2>
                        <p class="p">The following issues have been resolved in <span class="ph">NCCL</span> 2.27.7:
                        </p>
                        <ul class="ul">
                           <li class="li">
                              <p class="p">Fixed initialization failures in certain configurations when attempting to load fp8-specific
                                 symmetric multicast kernels on GPUs older than Blackwell.
                              </p>
                           </li>
                        </ul>
                     </div>
