---
type: RawSource
title: https://docs.nvidia.com/deeplearning/nccl/release-notes/rel_2-14-3.html
source_kind: web
url: https://docs.nvidia.com/deeplearning/nccl/release-notes/rel_2-14-3.html
captured: 2026-06-24
status: ingested
---
# Snapshot
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en-us" xml:lang="en-us">
   <head>
      ...
      <meta name="DC.Title" content="NCCL Release 2.14.3"></meta>
      <meta name="abstract" content=""></meta>
      <meta name="description" content=""></meta>
      <meta name="DC.Format" content="XHTML"></meta>
      <meta name="DC.Identifier" content="rel_2-14-3"></meta>
   ...
   <body>
      ...
      <div id="site-content">
         ...
         <div id="contents-container">
            ...
            <article id="contents">
               <div class="topic nested0" id="rel_2-14-3"><a name="rel_2-14-3" shape="rect">
                     <!-- --></a><h2 class="title topictitle1"><a href="#rel_2-14-3" name="rel_2-14-3" shape="rect"><span class="ph">NCCL</span> Release 2.14.3</a></h2>
                  <div class="body refbody">
                     <p class="shortdesc"></p>
                     <div class="section" id="rel_2-14-3__section_n2q_kp4_phb"><a name="rel_2-14-3__section_n2q_kp4_phb" shape="rect">
                           <!-- --></a><p class="p">This is the <span class="ph">NCCL</span> 2.14.3 release notes. For previous NCCL release notes, refer to the
                     ...
                     <div class="section">
                        ...
                        <div class="p"><span class="ph">NCCL</span> 2.14.3 has been tested with the following:<a name="rel_2-14-3__ul_g3n_yw2_mhb" shape="rect">
                              <!-- --></a><ul class="ul" id="rel_2-14-3__ul_g3n_yw2_mhb">
                              <li class="li">
                     ...
                     <div class="section">
                        ...
                        <ul class="ul">
                           <li class="li">
                              <p class="p">Add support for improved fault tolerance: non-blocking mode, new init function with configuration, new finalize function.</p>
                           </li>
                           <li class="li">
                              <p class="p">Reintroduce the collnet+chain algorithm.</p>
                           </li>
                           <li class="li">
                              <p class="p">Add LL protocol for intra-node send/recv communication, and inter-node (disabled by default).</p>
                           </li>
                           <li class="li">
                              <p class="p">Communicate through the network within a node instead of shared memory if
                                 performance would be better that way.
                              </p>
                           </li>
                        </ul>
                     </div>
                     <div class="section">
                        ...
                        <p class="p">The following issues have been resolved in <span class="ph">NCCL</span> 2.14.3:
                        </p>
                        <ul class="ul">
                           <li class="li">Wait for CUDA graph destruction before freeing communicator.</li>
                           <li class="li">Remove aggressive polling during enqueue.</li>
                           <li class="li">Fix DMABUF fallback on MOFED 5.4 and earlier.</li>
                           <li class="li">Fix <samp class="ph codeph">NCCL_DEBUG_FILE</samp> functionality.
                           </li>
                        </ul>
                     </div>
                     <div class="section">
