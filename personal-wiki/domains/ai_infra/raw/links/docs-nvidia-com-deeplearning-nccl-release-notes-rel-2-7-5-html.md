---
type: RawSource
title: https://docs.nvidia.com/deeplearning/nccl/release-notes/rel_2-7-5.html
source_kind: web
url: https://docs.nvidia.com/deeplearning/nccl/release-notes/rel_2-7-5.html
captured: 2026-06-24
status: pending
---
# Snapshot
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en-us" xml:lang="en-us">
   <head>
      ...
      <meta name="DC.Title" content="NCCL Release 2.7.5"></meta>
      <meta name="abstract" content=""></meta>
      <meta name="description" content=""></meta>
      <meta name="DC.Format" content="XHTML"></meta>
      <meta name="DC.Identifier" content="rel_2-7-5"></meta>
   ...
   <body>
      ...
      <div id="site-content">
         ...
         <div id="contents-container">
            ...
            <article id="contents">
               <div class="topic nested0" id="rel_2-7-5"><a name="rel_2-7-5" shape="rect">
                     <!-- --></a><h2 class="title topictitle1"><a href="#rel_2-7-5" name="rel_2-7-5" shape="rect"><span class="ph">NCCL</span> Release 2.7.5</a></h2>
                  <div class="body refbody">
                     <p class="shortdesc"></p>
                     <div class="section" id="rel_2-7-5__section_n2q_kp4_phb"><a name="rel_2-7-5__section_n2q_kp4_phb" shape="rect">
                           <!-- --></a><p class="p">This is the NCCL 2.7.5 release notes. For previous NCCL release notes, refer to the
                     ...
                     <div class="section">
                        ...
                        <div class="p">NCCL 2.7.5 has been tested with the following:<a name="rel_2-7-5__ul_g3n_yw2_mhb" shape="rect">
                              <!-- --></a><ul class="ul" id="rel_2-7-5__ul_g3n_yw2_mhb">
                              <li class="li">
                        ...
                        <ul class="ul">
                           <li class="li">
                              <p class="p">Using send/receive operations in combination to launch work on multiple GPUs from a single
                                 ...
                                 <strong class="ph b">Troubleshooting</strong> &gt; <strong class="ph b">Known Issues</strong> &gt; <a class="xref" href="https://docs.nvidia.com/deeplearning/nccl/user-guide/docs/troubleshooting.html#concurrency-between-nccl-and-cuda-calls-nccl-up-to-2-0-5-or-cuda-8" target="_blank" shape="rect">Concurrency Between NCCL and CUDA
                                    calls</a>. 
                              </p>
                           </li>
                           <li class="li">
                           ...
                           <li class="li">
                              <p class="p">Running inside a virtual machine on an NVswitch platform can cause a crash if NVswitch is not visible inside the virtual machine.</p>
                           </li>
                        </ul>
                     </div>
                     <div class="section">
                        <h2 class="title sectiontitle">Fixed Issues</h2>
                        <div class="p">The following issues have been resolved in NCCL 2.7.5:
                           <ul class="ul">
                              <li class="li">
                                 <p class="p">Minor fixes for A100 platforms.</p>
                              </li>
                              <li class="li">
                                 <p class="p">Add proper message for invalid <samp class="ph codeph">GroupEnd</samp> call.
                                 </p>
                              </li>
                           </ul>
                        </div>
