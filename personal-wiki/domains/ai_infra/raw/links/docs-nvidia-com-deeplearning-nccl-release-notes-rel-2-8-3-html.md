---
type: RawSource
title: https://docs.nvidia.com/deeplearning/nccl/release-notes/rel_2-8-3.html
source_kind: web
url: https://docs.nvidia.com/deeplearning/nccl/release-notes/rel_2-8-3.html
captured: 2026-06-24
status: ingested
---
# Snapshot
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en-us" xml:lang="en-us">
   <head>
      ...
      <meta name="DC.Title" content="NCCL Release 2.8.3"></meta>
      <meta name="abstract" content=""></meta>
      <meta name="description" content=""></meta>
      <meta name="DC.Format" content="XHTML"></meta>
      <meta name="DC.Identifier" content="rel_2-8-3"></meta>
   ...
   <body>
      ...
      <div id="site-content">
         ...
         <div id="contents-container">
            ...
            <article id="contents">
               <div class="topic nested0" id="rel_2-8-3"><a name="rel_2-8-3" shape="rect">
                     <!-- --></a><h2 class="title topictitle1"><a href="#rel_2-8-3" name="rel_2-8-3" shape="rect"><span class="ph">NCCL</span> Release 2.8.3</a></h2>
                  <div class="body refbody">
                     <p class="shortdesc"></p>
                     <div class="section" id="rel_2-8-3__section_n2q_kp4_phb"><a name="rel_2-8-3__section_n2q_kp4_phb" shape="rect">
                           <!-- --></a><p class="p">This is the NCCL 2.8.3 release notes. For previous NCCL release notes, refer to the
                     ...
                     <div class="section">
                        ...
                        <div class="p">NCCL 2.8.3 has been tested with the following:<a name="rel_2-8-3__ul_g3n_yw2_mhb" shape="rect">
                              <!-- --></a><ul class="ul" id="rel_2-8-3__ul_g3n_yw2_mhb">
                              <li class="li">
                     ...
                     <div class="section">
                        ...
                        <div class="p">This NCCL release includes the following key features and enhancements. 
                           <ul class="ul">
                              <li class="li">
                                 <p class="p">Optimized Tree performance on A100</p>
                              </li>
                              <li class="li">
                                 <p class="p">Improved performance for aggregated operations</p>
                              </li>
                              <li class="li">
                                 <p class="p">Improved performance for all-to-all operations at scale</p>
                              </li>
                              <li class="li">
                                 <p class="p">Reduced memory usage for all-to-all operations at scale</p>
                              </li>
                              <li class="li">
                                 <p class="p">Optimized all-to-all performance on DGX-1</p>
                              </li>
                           </ul>
                        </div>
                     </div>
                        ...
                        <ul class="ul">
                           <li class="li">
                              <p class="p">Using send/receive operations in combination to launch work on multiple GPUs from a single
                                 ...
                                 <strong class="ph b">Troubleshooting</strong> &gt; <strong class="ph b">Known Issues</strong> &gt; <a class="xref" href="https://docs.nvidia.com/deeplearning/nccl/archives/nccl_283/user-guide/docs/troubleshooting.html#concurrency-between-nccl-and-cuda-calls-nccl-up-to-2-0-5-or-cuda-8" target="_blank" shape="rect">Concurrency Between NCCL and CUDA
                                    calls</a>. 
                              </p>
                           </li>
                        </ul>
                     ...
                     <div class="section">
                        ...
                        <div class="p">The following issues have been resolved in NCCL 2.8.3:
                           <ul class="ul">
                              <li class="li">
                                 <p class="p">Hang in LL128 protocol after 2^31 steps.</p>
                              </li>
                              <li class="li">
                                 <p class="p">Topology injection error when using fewer GPUs than described. (github issue #379)</p>
                              </li>
                              <li class="li">
                                 <p class="p">Protocol mismatch causing hangs or crashes when using one GPU per node. (github issue #394)</p>
                              </li>
                           </ul>
                        </div>
                     </div>
