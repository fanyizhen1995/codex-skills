...
title: '[DO NOT MERGE] GLM 5.2 Reproduction scripts'
canonical_url: https://github.com/sgl-project/sglang/pull/30851
captured_at: '2026-07-15T23:40:28.382185+00:00'
content_hash: e9e53a76c88847334c06c437b16edd69b2b50284a7395c5ff5db0c54c6ee22a4
---
# [DO NOT MERGE] GLM 5.2 Reproduction scripts
...
Main Figure:
<img width="2048" height="1589" alt="glm52-nvfp4-performance-pareto" src="https://github.com/user-attachments/assets/3d4c519c-89c8-4933-bb0e-36ed30483d3b" />

ISL Ablation:
<img width="1464" height="966" alt="isl-ablation" src="https://github.com/user-attachments/assets/263d4897-ac88-4a8a-a00d-b04f62e5b866" />
...
```bash
# example: GB300, GLM-5.2 on v0.5.15.post1, both parallelism panels
