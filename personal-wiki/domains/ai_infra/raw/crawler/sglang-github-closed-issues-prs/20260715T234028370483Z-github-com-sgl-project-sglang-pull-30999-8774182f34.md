...
title: '[CI] Add JIT cache-state and phase-timing logs to attribute custom-all-reduce
  timeouts'
canonical_url: https://github.com/sgl-project/sglang/pull/30999
captured_at: '2026-07-15T23:40:28.370483+00:00'
content_hash: 8774182f34b4d3f86bae51dd5ed494be1fc784f00fa27818117f83eec02b88fd
---
# [CI] Add JIT cache-state and phase-timing logs to attribute custom-all-reduce timeouts

URL: https://github.com/sgl-project/sglang/pull/30999
State: closed
Labels: documentation, ci, run-ci, jit-kernel
Closed at: 2026-07-15T10:38:53Z
Merged at: 
...
Latest PR Test (Base): <!-- slot:pr-test:start -->:x: [Run #29260146598](https://github.com/sgl-project/sglang/actions/runs/29260146598)<!-- slot:pr-test:end -->
Latest PR Test (Extra): <!-- slot:pr-test-extra:start -->:x: [Run #29260144426](https://github.com/sgl-project/sglang/actions/runs/29260144426)<!-- slot:pr-test-extra:end -->
<!-- pr-states:end -->
