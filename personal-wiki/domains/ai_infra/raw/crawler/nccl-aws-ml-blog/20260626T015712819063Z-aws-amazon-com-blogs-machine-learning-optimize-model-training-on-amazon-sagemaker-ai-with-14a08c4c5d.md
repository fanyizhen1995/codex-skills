...
canonical_url: https://aws.amazon.com/blogs/machine-learning/optimize-model-training-on-amazon-sagemaker-ai-with-nvidia-blackwell/
captured_at: '2026-06-26T01:57:12.819063+00:00'
content_hash: 14a08c4c5d028d56720eec90d672c6c5fbade1b58c327eb146a5ecc0da7c8058
---
...
Access to ml.p6-b200.48xlarge instances through a 
Flexible Training Plan
 or 
...
Docker installed locally, Python 3.9 or later, and the 
SageMaker Python SDK
.

 
Familiarity with PyTorch and FSDP. If you are new to FSDP, see 
...
fsdp.py
 file from the 
FSDP example from the NVIDIA TransformerEngine repository
...
Delete your Amazon ECR repository
...
purchase a Flexible Training Plan
